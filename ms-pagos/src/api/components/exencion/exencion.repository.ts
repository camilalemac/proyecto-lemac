...
import Concepto from "../../../models/concepto.model"; // <-- Asegúrate de importar esto
    ...
    return Exencion.findAll({
      ...
      include: [
        { 
          model: CuentaCobrar, 
          as: "cobro",
          include: [{ model: Concepto, as: "concepto" }] // <-- Agregamos esto
        }
      ],
    ...
    return Exencion.findAll({
      ...
      include: [
        { 
          model: CuentaCobrar, 
          as: "cobro",
          include: [{ model: Concepto, as: "concepto" }] // <-- Y esto también
        }
      ],
