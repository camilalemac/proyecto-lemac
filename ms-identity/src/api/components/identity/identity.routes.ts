...
// GET /api/v1/identity/mis-hijos
router.get("/mis-hijos", checkJwt, identityController.getMisHijos);

router.get(
  "/users/:id",
  checkJwt, // Opcional/Recomendado: asegúrate de que el MS que llama tenga un token válido
